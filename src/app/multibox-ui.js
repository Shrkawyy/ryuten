...
(()=>{'use strict';const rp=window.RYUTEN_PORT,pp=rp.parentPort;
  ...
  rp.modules.installMultiboxUI=(h,r)=>{
    ...
    const mouseLabel=el('label',{className:'sp-mb-enable'},'Mouse spawn target — hold right-click to preview; release hides it; Tab requests spawn ');mouseLabel.prepend(mouse);dialog.append(mouseLabel);
